...
```{r, warning=FALSE, message=FALSE, fig.cap="**Figure 4:** Social Cost of Carbon versus a range of discount rates (1-5%). The red point indicates the Social Cost of Carbon using the Ramsey Rule equation, which was calulated to be **$2.393246e+12**."}
#Question 4
rams <- 0.001+(2*0.01)
...
The cost of undertaking **Policy B (X)** would have to be **$`r X_polB`** (difference between the expected values of Policies A and B) to make economic sense to pursue **Policy B** instead of the business-as-usual approach of **Policy A**. This answer would change if society was risk averse. The cost of implementing Policy B could increase to more than $`r X_polB` because the utility of the guaranteed reduction of global temperature change is higher than Policy A to a risk averse society. However, there is an undetermined value of X that would push even a risk averse society to adopt Policy A. This would depend on society's utility function. 